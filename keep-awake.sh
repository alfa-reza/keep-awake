...
# 1. Check if the charger is connected (precondition check)
...
# 2. Probe the inhibitor after the charger precondition succeeds
...
echo "• Lid-close suspend is inhibited through the active logind backend"
echo "• System sleep is inhibited; SSH availability still depends on networking"
echo
